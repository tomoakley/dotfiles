...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, f"file:///{home_dir}/Library/Application%20Support/qutebrowser/userscripts/*")

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, f"file:///{home_dir}/Library/Application%20Support/qutebrowser/userscripts/*")
